...
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerLabel('Login du nouveau producteur : ',"label"));
...
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerInputMdp('mdpIPProd', 'mdpIPProd',  1, 'Entrez un nouveau votre mot de passe', '',"form-control"));
$formulaireNewProd->ajouterComposantTab();


$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerLabel('Adresse du producteur',"label"));
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerInputMdp('adressProN', 'adressProN',  1, 'Entrez une nouvelle adresse', '',"form-control"));
$formulaireNewProd->ajouterComposantTab();

$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerLabel('Commune du nouveau producteur',"label"));
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerInputMdp('CommuneProN', 'CommuneProN',  1, 'Entrez une commune', '',"form-control"));
$formulaireNewProd->ajouterComposantTab();

$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerLabel('Code postal du producteur',"label"));
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerInputMdp('codePostalProN', 'codePostalProN',  1, 'Entrez un nouveau code postal', '',"form-control"));
$formulaireNewProd->ajouterComposantTab();

$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerLabel('Présentation du producteur',"label"));
$formulaireNewProd->ajouterComposantLigne($formulaireNewProd->creerInputMdp('presentProN', 'presentProN',  1, 'Entrez une nouvelle présentation', '',"form-control"));
$formulaireNewProd->ajouterComposantTab();
...
require_once 'vues/bioRelai/vueBioRelaiProducteurs.php' ;
